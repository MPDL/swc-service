...
import de.mpg.mpdl.service.rest.swc.wiremock.AcceptanceTestBase;
import de.mpg.mpdl.service.rest.swc.wiremock.WireMockResponse;
...
public class WireMockTest extends AcceptanceTestBase {
    ...
    public void exampleTest() {
       ...
       System.out.println("port:" + wireMockServer.port());
        ...
        stubFor(get(urlEqualTo("/screenshot/path?useFireFox=true"))
                        .willReturn(aResponse()
                                        .withStatus(200)
                                        .withHeader("Content-Type", "image/png")
                                        .withBodyFile("DSC04350.JPG")
                        )
        ...
        WireMockResponse response = testClient.get("/screenshot/path?useFireFox=true");
