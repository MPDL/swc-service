...
public class RestProcessUtils {
    ...
    public static String generateHtmlRepresentationFromFiles(HttpServletRequest request) throws FileUploadException, IOException {
    ...
    InputStream stream = new RestProcessUtils().getClass().getClassLoader().getResourceAsStream(fileName);
